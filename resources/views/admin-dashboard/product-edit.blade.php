             ...
             <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="{{route('update',$product->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT') 
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="number" name="discount_price"class="form-control" id="exampleInputPassword4" placeholder="Price" value="{{$product->discount_price}}">
                    </div>
                    <div class="form-group">
